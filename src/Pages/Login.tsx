  ...
  return (
    <div className=" w-full h-screen flex flex-col items-center justify-center text-[#07161a]">
      <div className="mb-10 w-full gap-4 flex flex-col items-start max-w-xs md:max-w-md ">
        <h2 className=" text-5xl font-semibold tracking-wide opacity-80">
          WELCOME BACK!
        </h2>
        <p className=" text-xl tracking-wide">
          Don't have an account?{" "}
          <a href="/SignUp" className="text-[#e7634b] underline">
            Sign Up
          </a>
        </p>
      </div>
      <form
       ...
       className=" md:w-full gap-6 flex flex-col max-w-md">
        ...
        <div className="form-control w-full">
          <label className="label">
            <span className="label-text tracking-wide text-lg">Password</span>
          </label>
          <input
            type="password"
        ...
        <button
          className="p-2 bg-[#e7634b] hover:bg-white hover:text-[#e6734b] text-white duration-300 text-xl rounded-full w-full max-w-md"
          onClick={authing ? undefined : handleEmailAndPasswordLogin}
        >
