  ...
  return (
      <div className=" w-full h-screen flex flex-col items-center justify-center text-[#07161a]">
        <div className="mb-10 w-full gap-4 flex flex-col items-start max-w-xs md:max-w-md ">
          <h2 className=" text-5xl font-semibold tracking-wide opacity-80">WELCOME BACK!</h2>
        ...
        <form className=" md:w-full gap-6 flex flex-col max-w-md">
          ...
          <div className="w-full max-w-md flex justify-between opacity-60 mb-4">
            <div className="flex mr-2">
            <input type="checkbox" className="checkbox rounded-xl border-2 border-black" />
