  ...
  return (
    <div className='text-7xl h-screen flex items-center m-auto justify-between bg-[#586F7C] px-36'>
      ...
      <div className='flex flex-col items-center gap-10'>
        ...
        Have fun and learn at the same time with  <span className='text-[#e7634b]'>A</span>ctivities 
        </h1>
        <button className='p-4 bg-[#e7634b] text-white rounded-2xl text-xl mx-auto hover:scale-110 duration-300 hover:border-b-4 hover:border-white'>Start Now</button>
        </div>
    </div>
  )
}
